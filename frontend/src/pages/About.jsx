    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12 items-center">
        <img
          ...
          alt="Healthcare professionals illustration - Prescripto"
        />

        <div className="flex flex-col justify-center gap-5 md:w-2/4 text-gray-600 text-base leading-relaxed">
          <p>
            Welcome to{" "}
            <span className="font-medium text-gray-800">Prescripto</span>, your
